...
WIDTH, HEIGHT = 700, 700 # Slightly different than Tim's screen which is 750,750
	...
	while run:
		...
		if len(enemies) == 0:
			...
			for i in range(wave_length):
				# Spawn the enemies above the screen (not visible) at random x, y positons
